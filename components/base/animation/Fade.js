...
const TheComponent = class extends Component {
	...
	render() {
		var opacity = this.state.animated_value.interpolate({
			inputRange: [0, 1],
			outputRange: [this.props.inactiveOpacity||0, 1]  // 0 : 150, 0.5 : 75, 1 : 0
		});
		return (
			<Animated.View
				style={[{overflow: 'hidden', opacity}, this.props.style]}>
				{this.props.children}
			</Animated.View>
		);
	}
